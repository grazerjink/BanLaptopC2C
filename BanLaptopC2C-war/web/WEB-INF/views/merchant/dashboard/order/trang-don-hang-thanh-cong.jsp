...
<script>
    $(function () {
        ...
        $(".applyBtn").click(function() {
            ...
            document.location.href = 'merchant/don-dat-hang/thanh-cong/loc-du-lieu?batDau='+batDau+'&ketThuc='+ketThuc;
        });
        $(".v2q-order-filter").click(function() {
            document.location.href = 'merchant/don-dat-hang/thanh-cong/';
        });
    });
</script>
<div class="ks-header">
    <section class="ks-title">
        <h3>Danh sách đơn đặt hàng đã hoàn tất</h3>
    </section>
</div>
...
<jsp:include page="cap-nhat-tinh-trang-thanh-cong.jsp"/>