...
<script>
    $(function () {
        $("#btn-update-status").click(function () {
            ...
            alert(idTinhTrang);
            $.ajax({
                url: "merchant/don-dat-hang/moi/cap-nhat-tinh-trang/",
                dataType: 'json',
                data: {
                    idDonHang: idDonHang,
                    ...
                    <tbody>    
                        ...
                        <tr>
                            ...
                            <td class="v2q-popup-tinhtrang">
                                <label for="tinhTrang"> 
                                    <input type="radio" name="tinhTrang" id="tinhTrang" value="XL" />
                                    Đang xử lý
                                </label>
                                <label for="tinhTrang1"> 
                                    <input type="radio" name="tinhTrang" id="tinhTrang1" value="DG" />
                                    Đang giao hàng
                                </label>
