                    ...
                    <div class="col-lg-4">
                                ...
                                <table class="table ks-payment-card-rate-details-table">
                                    <tr>
                                        <td class="ks-currency">
                                            <img src="assets/merchant/template/img/flags/24/United-States.png" class="ks-flag">
                                            US Dollar
                                        </td>
                                    ...
                                    <tr>
                                        <td class="ks-currency">
                                            <img src="assets/merchant/template/img/flags/24/United-Kingdom.png" class="ks-flag">
                                            Pounds Sterling
                                        </td>
                                    ...
                                    <tr>
                                        <td class="ks-currency">
                                            <img src="assets/merchant/template/img/flags/24/European-Union.png" class="ks-flag">
                                            Euro
                                        </td>
                                    ...
                                    <tr>
                                        <td class="ks-currency">
                                            <img src="assets/merchant/template/img/flags/24/Canada.png" class="ks-flag">
                                            Canadian Dollar
                                        </td>
                                    ...
                                    <tr>
                                        <td class="ks-currency">
                                            <img src="assets/merchant/template/img/flags/24/United-Arab-Emirates.png" class="ks-flag">
                                            U.A.E. Dirham
                                        </td>
                        ...
                        <div class="card ks-card-widget ks-widget-payment-budget">
                            <a href="#" class="ks-thumbnail">
                                <img src="assets/merchant/template/img/widgets/cover.png" class="embed-responsive">
                            </a>
                                ...
                                <table class="table ks-payment-table">
                                    <tr>
                                        <td class="ks-text-bold ks-text-no-wrap">
                                            <img src="assets/merchant/template/img/avatars/avatar-1.jpg" width="28" height="28" class="ks-avatar ks-img-circle"> John Doe
                                        </td>
                                    ...
                                    <tr>
                                        <td class="ks-text-bold ks-text-no-wrap">
                                            <img src="assets/merchant/template/img/avatars/avatar-8.jpg" width="28" height="28" class="ks-avatar ks-img-circle"> John Doe
                                        </td>
                                        <td class="ks-text-light">Easy One Page Dashboard</td>
                                        <td class="ks-text-bold">$150</td>
                                        <td class="ks-text-light ks-text-right ks-text-no-wrap">3 days ago</td>
                                    ...
                                    <tr>
                                        <td class="ks-text-bold ks-text-no-wrap">
                                            <img src="assets/merchant/template/img/avatars/avatar-9.jpg" width="28" height="28" class="ks-avatar ks-img-circle"> John Doe
                                        </td>
                                        <td class="ks-text-light">Easy One Page Dashboard</td>
                                        <td class="ks-text-bold">$150</td>
                                        <td class="ks-text-light ks-text-right ks-text-no-wrap">3 days ago</td>
                                    ...
                                    <tr>
                                        <td class="ks-text-bold ks-text-no-wrap">
                                            <img src="assets/merchant/template/img/avatars/avatar-10.jpg" width="28" height="28" class="ks-avatar ks-img-circle"> John Doe
                                        </td>
                                        <td class="ks-text-light">Easy One Page Dashboard</td>
                                        <td class="ks-text-bold">$150</td>
                                        <td class="ks-text-light ks-text-right ks-text-no-wrap">3 days ago</td>
                                    ...
                                    <tr>
                                        <td class="ks-text-bold ks-text-no-wrap">
                                            <img src="assets/merchant/template/img/avatars/avatar-11.jpg" width="28" height="28" class="ks-avatar ks-img-circle"> John Doe
                                        </td>
                                        <td class="ks-text-light">Easy One Page Dashboard</td>
                                        <td class="ks-text-bold">$150</td>
                                        <td class="ks-text-light ks-text-right ks-text-no-wrap">3 days ago</td>
                                ...
                                <div class="row">
                                    <div class="col-lg-5">
                                        <table class="table ks-payment-widget-table-and-map-table">
                                            ...
                                            <tr>
                                                <td class="ks-flag" width="20">
                                                    <img src="assets/merchant/template/img/flags/24/France.png" class="ks-flag">
                                                </td>
                                                <td>
                                                    France
                                                </td>
                                            ...
                                            <tr>
                                                <td class="ks-flag" width="20">
                                                    <img src="assets/merchant/template/img/flags/24/Germany.png" class="ks-flag">
                                                </td>
                                                <td>
                                                    Germany
                                                </td>
                                            ...
                                            <tr>
                                                <td class="ks-flag" width="20">
                                                    <img src="assets/merchant/template/img/flags/24/Spain.png" class="ks-flag">
                                                </td>
                                                <td>
                                                    Spain
                                                </td>
                                            ...
                                            <tr>
                                                <td class="ks-flag" width="20">
                                                    <img src="assets/merchant/template/img/flags/24/Russia.png" class="ks-flag">
                                                </td>
                                                <td>
                                                    Russia
                                                </td>
                                ...
                                <div class="ks-widget-messages-inbox-items">
                                    <a href="#" class="ks-widget-messages-inbox-item">
                                        <div class="ks-widget-messages-inbox-item-avatar ks-avatar ks-online">
                                            <img src="assets/merchant/template/img/avatars/avatar-6.jpg" width="36" height="36">
                                        </div>
                                    ...
                                    <a href="#" class="ks-widget-messages-inbox-item">
                                        <div class="ks-widget-messages-inbox-item-avatar ks-avatar ks-online">
                                            <img src="assets/merchant/template/img/avatars/avatar-4.jpg" width="36" height="36">
                                        </div>
                                        <div class="ks-widget-messages-inbox-item-body">
                                            <div class="ks-widget-messages-inbox-item-body-name-and-time">
                                                <span class="ks-name">Konstantin Berezhski</span>
                                    ...
                                    <a href="#" class="ks-widget-messages-inbox-item">
                                        <div class="ks-widget-messages-inbox-item-avatar ks-avatar ks-offline">
                                            <img src="assets/merchant/template/img/avatars/avatar-2.jpg" width="36" height="36">
                                        </div>
                                        <div class="ks-widget-messages-inbox-item-body">
                                            <div class="ks-widget-messages-inbox-item-body-name-and-time">
                                                <span class="ks-name">Konstantin Berezhski</span>
                                    ...
                                    <a href="#" class="ks-widget-messages-inbox-item">
                                        <div class="ks-widget-messages-inbox-item-avatar ks-avatar ks-online">
                                            <img src="assets/merchant/template/img/avatars/avatar-13.jpg" width="36" height="36">
                                        </div>
                                        <div class="ks-widget-messages-inbox-item-body">
                                            <div class="ks-widget-messages-inbox-item-body-name-and-time">
                                                <span class="ks-name">Konstantin Berezhski</span>
