                ...
                <div class="ks-wrapper ks-scrollable">
                    <a href="#" class="ks-message">
                        <div class="ks-avatar ks-online">
                            <img src="assets/merchant/template/img/avatars/avatar-1.jpg" width="36" height="36">
                        </div>
                        <div class="ks-info">
                    ...
                    <a href="#" class="ks-message">
                        <div class="ks-avatar ks-online">
                            <img src="assets/merchant/template/img/avatars/avatar-5.jpg" width="36" height="36">
                        </div>
                        <div class="ks-info">
                            <div class="ks-user-name">Emily Carter</div>
                            <div class="ks-text">In golf, Danny Willett (pictured) wins the M...</div>
                    ...
                    <a href="#" class="ks-message">
                        <div class="ks-avatar ks-offline">
                            <img src="assets/merchant/template/img/avatars/placeholders/ava-36.png" width="36" height="36">
                        </div>
                        <div class="ks-info">
                            <div class="ks-user-name">Emily Carter</div>
                            <div class="ks-text">In golf, Danny Willett (pictured) wins the M...</div>
