...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="assets/merchant/template/libs/noty/noty.css">
        ...
        <script src="assets/merchant/js/my-custom-scripts.js" type="application/javascript"></script>
